define(function(require, exports, module){
	...
	function fix_super(Super, method){
		if (method instanceof Function && super_regx.test(method.toString())){
			return function(){
				var originSuper = this.Super;
				if (this !== window){
					this.Super = Super;
				}
				var ret = method.apply(this, arguments);
				this.Super = originSuper;
				return ret;
			};
		}else {
			return method;
	...
	Messager.prototype = {
		...
		triggerFree: function() {
			var item;
			while (item = this.freeCbs.shift()) {
				var args = [].slice.call(2);
		 ...
		 * callback只会触发一次
		 */
		onFree: function(callback, context/*, ...args*/) {
			this.freeCbs.push(arguments);
